...
## NAME     [top](https://man7.org/linux/man-pages/man1/pstree.1.html#top_of_page)

```
       pstree - display a tree of processes
```

## SYNOPSIS     [top](https://man7.org/linux/man-pages/man1/pstree.1.html#top_of_page)
...
## DESCRIPTION     [top](https://man7.org/linux/man-pages/man1/pstree.1.html#top_of_page)
...
## OPTIONS     [top](https://man7.org/linux/man-pages/man1/pstree.1.html#top_of_page)
...
## FILES     [top](https://man7.org/linux/man-pages/man1/pstree.1.html#top_of_page)

```
       /proc  location of the proc file system
```

## BUGS     [top](https://man7.org/linux/man-pages/man1/pstree.1.html#top_of_page)
...
## SEE ALSO     [top](https://man7.org/linux/man-pages/man1/pstree.1.html#top_of_page)

```
       ps(1), top(1), proc(5).
```

## COLOPHON     [top](https://man7.org/linux/man-pages/man1/pstree.1.html#top_of_page)
